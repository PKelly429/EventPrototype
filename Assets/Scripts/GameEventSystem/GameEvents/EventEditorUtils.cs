...
namespace GameEventSystem.GameEvents.Editor
{
    public static class EventEditorUtils
    {
        ...
        public static void DrawLinkText(string text, IBlackboard blackboard, List<IBlackboard> extraBlackboards, params VariableReference[] variables)
        {
            ...
            using (var h = new GUILayout.HorizontalScope())
            {
                ...
                while(i < variables.Length)
                {
                    ...
                    if (GUILayout.Button(variables[i].GetName(), EditorStyles.linkLabel, GUILayout.ExpandWidth(false)))
                    {
